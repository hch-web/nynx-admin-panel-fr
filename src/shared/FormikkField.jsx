...
// STYLES
import styles from 'styles/containers/formik-field.module.scss';

function FormikkField({
  type,
  fullWidth,
  name,
  className,
        ...
        <div className={`${styles.formGroup}`} style={{ maxWidth: fullWidth ? '100%' : '400px' }}>
          <div className="position-relative">
            <input
              ...
              placeholder={placeholder}
              style={{
                borderColor: error && touched ? 'red' : '#e3d6d1',
              }}
              value={innerValue}
              onChange={handleChange}
              onBlur={handleBlur}
          ...
          <div className="d-flex align-items-center justify-content-between mt-1">
            ...
            {wordsCounter && (
              ...
              >
                {`${String(innerValue)?.length}/30 character`}
              </span>
            )}
          </div>
        </div>
